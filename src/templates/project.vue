        ...
        >
          <el-row>
            ...
            <el-col :span="8" style="text-align: right">
              <el-tag size="small" type="danger" v-if="project.license && project.license.name">{{project.license.name}}</el-tag>
              <el-tag size="small" type="success" v-if="project.language" style="margin-left: 12px">{{project.language}}</el-tag>
            </el-col>
          </el-row>
        </div>
        <div
